              ...
              <div class="row">
                <div class="col-xl-12 py-2">
                  <div class="col-12 mb-3">
                    ...
                    <image-cropper :isPng="isPng" :name="data.id" caption="" :hasCaption="hasCaption"
                                   :isRequired="imgRequired" :aspect="aspect" :src="data.image"/>
                ...
                <div class="col-xl-12 py-2">
                  <label :for="'title_en_'+data.id">عنوان انگلیسی</label>
                  <input type="text" class="form-control border-0 col-auto"
                         :id="'title_en_'+data.id" :value="data.title_en">
                </div>
                <div class="col-xl-12 py-2">
                  <label :for="'title_ar_'+data.id">عنوان عربی</label>
                  <input type="text" class="form-control border-0 col-auto"
                         :id="'title_ar_'+data.id" :value="data.title_ar">
                </div>
