                            ...
                            <form id = "editForm">
                                ...
                                <div class = "row">
                                    ...
                                    <div class = "col-md-4 col-xl-3 mb-3">
                                        ...
                                        <select @change="showProducts" class = "form-select" id = "productCategory" aria-describedby = "categoryHelp" aria-label = "category" required>
                                            <option value = ""></option>
                                            <!--                                            -->
                                            <option :selected = "data.product.category.id == Pcategory.id" v-for = "Pcategory in productCategories" :key = "Pcategory.id" :value = "Pcategory.id">
                                                {{ Pcategory.title }}
                                            </option>
                                        </select>
                                    ...
                                    <div class = "col-md-4 col-xl-3 mb-3">
                                        ...
                                        <select class = "form-select" id = "product_id" aria-describedby = "productHelp" aria-label = "product" required>
                                            <!--                                          -->
                                            <option :selected = "data.product.id == product.id" v-for = "product in products" :key = "product.id" :value = "product.id">
                                                {{ product.title }}
                                            </option>
                                        </select>
